<script src="{{ asset('assets/capital-finance.uk account area_files/modernizr-3.5.0.min.js.download') }}"></script>

<script src="{{ asset('assets/capital-finance.uk account area_files/jquery-1.12.4.min.js.download') }}"></script>

<script src="{{ asset('assets/capital-finance.uk account area_files/slick.min.js.download') }}"></script>

<script src="{{ asset('assets/capital-finance.uk account area_files/jquery.waterwheelCarousel.min.js.download') }}"></script>

<script src="{{ asset('assets/capital-finance.uk account area_files/ajax-form.js.download') }}"></script>

<script src="{{ asset('assets/capital-finance.uk account area_files/jquery.counterup.min.js.download') }}"></script>

<script src="{{ asset('assets/capital-finance.uk account area_files/jquery.waypoints.min.js.download') }}"></script>

<script src="{{ asset('assets/capital-finance.uk account area_files/wow.min.js.download') }}"></script>

<script src="{{ asset('assets/capital-finance.uk account area_files/imagesloaded.pkgd.min.js.download') }}"></script>

<script src="{{ asset('assets/capital-finance.uk account area_files/jquery.bundle.js.download') }}"></script>

<script src="{{ asset('assets/capital-finance.uk account area_files/script.js.download') }}"></script>

<script src="{{ asset('assets/capital-finance.uk account area_files/calc.js.download') }}"></script>
...
<script type="text/javascript">
    ...
    s1.async = true;
    s1.src = 'https://embed.tawk.to/5f27b97d1a544e2a7275d5a8/default';
    s1.charset = 'UTF-8';
